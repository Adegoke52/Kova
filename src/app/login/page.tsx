      ...
      >
        <div className="bg-white/5 backdrop-blur-3xl border border-white/10 rounded-[3rem] p-10 shadow-[0_50px_100px_-20px_rgba(0,0,0,0.5)] space-y-10">
          ...
          <div className="text-center space-y-4">
            ...
            <h1 className="text-3xl font-black text-white tracking-tight pt-4">Welcome back.</h1>
            <p className="text-white/60 font-medium">Log in to manage your premium brand.</p>
          </div>
          ...
          {!showWhatsAppLogin && (
            <>
              ...
              <Button 
                ...
                className="w-full h-14 rounded-2xl border-white/10 text-white hover:bg-white/5 font-black text-sm transition-all"
              >
